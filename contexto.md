...
A partir de $\mu_1, \dots, \mu_4$ se deducen de forma exacta: $$\mathrm{Var}(X) = \mu_2 - \mu_1^2, \quad \sigma = \sqrt{\mathrm{Var}(X)}$$ $$\text{Skewness } (\gamma_1) = \frac{\mu_3 - 3\mu_1\mu_2 + 2\mu_1^3}{\sigma^3}$$ $$\text{Kurtosis } (\gamma_2) = \frac{\mu_4 - 4\mu_1\mu_3 + 6\mu_1^2\mu_2 - 3\mu_1^4}{\sigma^4}$$
